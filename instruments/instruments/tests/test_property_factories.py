...
def test_enum_property_input_decoration():
    ...
    class EnumMock(MockInstrument):
        ...
        def input_decorator(input):
            return 'aa'
        a = enum_property(
            'MOCK:A', SillyEnum, input_decoration=input_decorator)
...
def test_enum_property_output_decoration():
    ...
    class EnumMock(MockInstrument):
        ...
        def output_decorator(input):
            return 'foobar'
        a = enum_property(
            'MOCK:A', SillyEnum, output_decoration=output_decorator)
...
def test_unitful_property_input_decoration():
    class UnitfulMock(MockInstrument):
        ...
        def input_decorator(input):
            return '1'
        a = unitful_property(
            'MOCK:A', pq.hertz, input_decoration=input_decorator)
...
def test_unitful_property_output_decoration():
    class UnitfulMock(MockInstrument):
        ...
        def output_decorator(input):
            return '1'
        a = unitful_property(
            'MOCK:A', pq.hertz, output_decoration=output_decorator)
