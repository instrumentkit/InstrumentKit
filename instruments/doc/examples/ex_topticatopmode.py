...
print("The laser1's temperature controller state is: ", tm.laser1.temperature_controller_status)
print("The laser1's current controller state is: ", tm.laser1.current_controller_status)
